...
<h2 style="text-align:center;border-radius:10px;width:35%; background:white;color:#123132;margin-right:35%;">Add Product</h2>
...
label{
	...
	<input style="text-align:center;border-radius:10px;width:90%;height:35px;background:#123132;color:white;" type='submit' name='send' id='add' value='Send' >
	<th>
	<tr>
	</form>
